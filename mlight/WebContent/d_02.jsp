		...
		<form method=post name=form action="./d_02_write.jsp" style="font-family: 'Cinzel', serif;">
			<table cellspacing=1 border=1>
				<tr>
					...
					<td width=500><input type="text" name="name" id="name" style="font-family: 'Noto Serif KR', serif;"><span
				...
				<tr>
					...
					<td width=500>
						...
						%> <input type="date" name="date" id="date" min="<%=now%>" max="<%=after%>" style="font-family: 'Noto Serif KR', serif;"><span
 ...
 %>
				...
				<tr>
					...
					<td width=500><input type="text" name="addr" id="addr"
						style="width: 400px; font-family: 'Noto Serif KR', serif;"><span class="error" id="errMsg_04"
						style="font-size: 1em"></span></td>
				</tr>
				<tr>
					<td width=100 align=center>Tel</td>
					<td width=500><input type="search" name="tel" id="tel" style="font-family: 'Noto Serif KR', serif;">ex)
				...
				<tr>
					...
					<td width=500><input type="text" name="inname" id="inname" style="font-family: 'Noto Serif KR', serif;"><span
				...
				<tr>
					...
					<td width=500><input type="text" name="comment"
						style="width: 400px; font-family: 'Noto Serif KR', serif;"></td>
				</tr>
				<tr>
